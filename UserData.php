            ...
            <div class="page-container">
                ...
                <div class="main-wrapper">
                    ...
                    if (!empty($_SESSION['username'])) {
                            ...
                            echo '<h2>Στοιχεία χρήστη ' . $user->getUsername() .'</h2>';

                            ?>
                            <hr>
                            <table style="width: 400px; text-align: center;" align="center" border="1">
                                <tr>
                                ...
                                <tr>
                                 ...
                                 <tr>
                                    <td><strong>Εmail:</strong></td>
                                    <td><?php echo $user->getEmail(); ?></td>
                                </tr>
                                <tr>
                                    <td><strong>Αριθμός Ταυτότητας:</strong></td>
                                ...
                                <tr>
                                    <td><strong>Hμ. Δημ. Λογαριασμού:</strong></td>
